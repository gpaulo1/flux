...
public class AccountReceivableController {
	...
	public ModelAndView salvar(
			@ModelAttribute("account") AccountReceivable account,
	...
	public @ResponseBody List<ClienteFindMainDTO> buscarCliente(
	...
	public ModelAndView listar(@PathVariable("id") Long id, RedirectAttributes redirect) {
